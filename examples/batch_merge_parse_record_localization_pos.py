...
def test_record_trans(reader_path):
    ...
    """
    data_list = list()
    header_parser = Parser.HeaderParser("Localization_Pos")
    ...
    for channel_name, msg, datatype, timestamp in freader.read_messages():
        ...
        # if channelname == CHANNEL_NAME and time_bias >=count:
            ...
            if datatype == MSG_TYPE:
                msg_new = localization_pb2.LocalizationEstimate()               
...
if __name__ == '__main__':
    ...
    saveList(record_list, '/apollo/record_localization_pos.pkl_'+ trail_name + '.pkl')

    rlist = loadList('/apollo/record_localization_pos.pkl_'+ trail_name + '.pkl')
