...
MSG_TYPE = "apollo.prediction.PredictionObstacles"
...
def test_record_trans(reader_path):
    ...
    """
    data_list = list()
    header_parser = Parser.HeaderParser("Prediction")
    ...
    for channel_name, msg, datatype, timestamp in freader.read_messages():
        ...
        # if channelname == CHANNEL_NAME and time_bias >=count:
            ...
            if datatype == MSG_TYPE:
                msg_new = prediction_obstacle_pb2.PredictionObstacles()
...
if __name__ == '__main__':
    ...
    cyber.shutdown()
    saveList(record_list, "/apollo/record_prediction_obstacles.pkl")

    rlist = loadList('/apollo/record_prediction_obstacles.pkl')
